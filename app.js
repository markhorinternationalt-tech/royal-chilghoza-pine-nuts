  ...
  g.innerHTML=Array.from(
    ...
    (_,i)=>`
      <figure>
        <img
          loading="lazy"
          src="/assets/${String(i+1).padStart(3,'0')}.jpg"
